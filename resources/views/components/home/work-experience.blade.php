<div id="roadmap" class="section-container" data-bg-color="white">
    <div class="timeline ">
        ...
        <div class="timeline-container right">
            <div class="date">Jan 2021- May 2021</div>
            <i class="icon fa-solid fa-house-laptop"></i>
            <div class="content">
                <div>
                    <img src="{{asset('img/silkron.png')}}" style="height:60px !important" alt="">
                </div>
        ...
        <div class="timeline-container left">
            <div class="date">June 2020 - Sept 2020</div>
            <i class="icon fa-solid fa-house-laptop"></i>
            <div class="content">
        ...
        <div class="timeline-container right">
            <div class="date">June 2018- Sept 2018</div>
            <i class="icon fa-solid fa-house-laptop"></i>
            <div class="content">
                <div>
