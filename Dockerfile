...
COPY new_docker/start-container /usr/local/bin/start-container
COPY new_docker/supervisord.conf /etc/supervisor/conf.d/supervisord.conf
COPY new_docker/php.ini /etc/php/8.0/cli/conf.d/99-sail.ini
